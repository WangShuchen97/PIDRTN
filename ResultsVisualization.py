...
from deepraytracing.utils.visualization import CIR_Single_Point,Building_CIR_Integration,Building_HeatMap,split_image,histogram,Line_Chart_Plot
from deepraytracing.utils.tool import mse

dataset_path='./data'
dataset_input='input'
is_regeneration=False
output_times=2.5
output_dir=["./results/DRTN","./results/DRTN_A"]
...
label=['CIR from RT method','CIR from DRTN model','CIR from DRTN-A model']
...
#=====================
#MSE Histogram
output_dir_=["./results/DRTN_A","./results/DRTN","./results/Unet"]
...
label=['DRTN-A','DRTN','Unet']

histogram(categories,mean,data_max,data_min,color,label,y_interval=[0,0.0003,0.0006,0.0009,0.0012,0.0015,0.0018,0.0050,0.0300])
