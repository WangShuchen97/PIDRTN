...
from deepraytracing.data_provider import datasets_factory
from deepraytracing.models import model_factory
from deepraytracing import trainer
...
parser = argparse.ArgumentParser(description='Deepraytracing')
...
parser.add_argument('--model_name', type=str, default='deepraytracing')
#data configs
...
if __name__ == "__main__":
    ...
    # configs.model_name='deepraytracing'
    # configs.model_name='unet'
    # configs.model_name='deepraytracing_A'
    
    if configs.model_name=='deepraytracing_A':
    ...
    if configs.mode=="test":
        if configs.model_name=='deepraytracing':
            configs.test_load_name='DRTN'
            configs.output_dir="results/DRTN"
        if configs.model_name=='deepraytracing_A':
            
            configs.test_load_name='DRTN-A'
            configs.output_dir="results/DRTN_A"
        if configs.model_name=='unet':
            configs.test_load_name='Unet'
            configs.output_dir="results/Unet"
