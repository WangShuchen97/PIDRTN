...
from deepraytracing.models import Deepraytracing
from deepraytracing.models import Deepraytracing_A
from deepraytracing.models import Unet
from deepraytracing.models.custom_losses import CustomSquareLoss,CustomSplitLoss
...
class Model(object):
    def __init__(self, configs):
        ...
        networks_map = {
            'deepraytracing': Deepraytracing.Deepraytracing,
            'deepraytracing_A': Deepraytracing_A.Deepraytracing_A,
            'unet': Unet.Unet
        }
        loss_map={
